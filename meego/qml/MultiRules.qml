/*
    Rules of the three- and four-player games (MeeGo edition of
    qml-common/MultiRules.qml, QtQuick 1.1). The Hungarian word "hívó" is
    passed as an argument: qsTr() of this Qt only handles Latin-1 sources,
    so translation keys stay ASCII.
*/
import QtQuick 1.1
